    ...
    return (
      <div>
        <div className="toolbar">
          <a className="IconButton" href="//torchapps.github.io">
            <i className="icon-torch" />
          </a>
          <div>Butthurt</div>
          ...
          <a className="IconButton" target="_blank" href="https://docs.google.com/forms/d/1Cexh4k5-nfwX9RKmv7Dwd4DcGweXLh8Kn6iZXbob0hU/viewform">
