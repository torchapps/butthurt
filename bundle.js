	...
	var App = React.createClass({displayName: "App",
	  ...
	  render: function(){
	    ...
	    var butthurtList = this.state.butthurts.map(function(butthurt, index){
	      return (
	        React.createElement("div", {className: "butthurt-container selectable horizontal layout", style: getStyle(butthurt.interval)}, 
	    ...
	    return (
	      React.createElement("div", null, 
	        React.createElement("div", {id: "donate"}, 
	          React.createElement("form", {target: "_blank", id: "donate", action: "https://www.paypal.com/cgi-bin/webscr", method: "post", class: "ng-pristine ng-valid"}, 
	            ...
	            React.createElement("button", {type: "submit", class: "clearfix"}, 
	              React.createElement("div", null, 
	            ...
	            React.createElement("img", {class: "go-away", alt: "", border: "0", src: "https://www.paypalobjects.com/en_US/i/scr/pixel.gif", width: "1", height: "1"})
	          )
	        ), 
